...
Original file is located at
    https://colab.research.google.com/drive/1tZ1DJ5zae5MOvFztMMEUf2eOcEGjiyYO
"""
...
def _build(nums: List[int], left: int, right: int):
    ...
    root.left = _build(nums, left, middle - 1)
    root.right = _build(nums, middle + 1, right)
    return root
...
def insert_bst(root: Optional[TreeNode], value: int)-> Optional[TreeNode]:
   if root is None:
...
def build_class_bst():
    ...
    my_group_ids = [1031,1032,1033,1034,1035,1036]

    all_students = sorted(list((set(nums + my_group_ids))
))

    root= sorted_array_to_bst(all_students)
