...
Original file is located at
    https://colab.research.google.com/drive/1YBSLAxUO90jEa6LZle1COraeHKVmHbvC
"""
...
def build_submission_tree(base_path: str, folder1: str, folder2: str) -> TreeNode:
    ...
    root = TreeNode(base_path)
        ...
        for folder_node, folder_name in [(root.left, folder1), (root.right, folder2)]:
